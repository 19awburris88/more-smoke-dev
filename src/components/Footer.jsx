  ...
  return (
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-col">
          <p className="footer-heading">TECH I USE</p>
        ...
        <div className="footer-col">
          ...
          <div className="footer-social">
            ...
            <a href="https://github.com/19awburris88" target="_blank" rel="noreferrer" aria-label="GitHub">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.linkedin.com/in/austin-burris-33995048/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
